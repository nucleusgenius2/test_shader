local unitName  =  "rhino"

local unitDef  =  {
    --Внутренние настройки
    BuildPic = "Hunter.png",
    Category = "TANK SMALL NOTAIR NOTSUB",
      --ObjectName = "EDF/land/Hunter.dae",
    ObjectName = "model_for_test/Rhino.s3o",
    name = "Rhino",
    Side = "Vroomers",
    TEDClass = "Vech",
    UnitName = "Rhino",
   ...
   --pushResistant = 1,
    ...
    customParams = {
        ...
        --апгрейды
        attack_land_unit_level_1_for_tech_1 = true,
        attack_land_unit_level_1_for_tech_2 = true
    }
}
